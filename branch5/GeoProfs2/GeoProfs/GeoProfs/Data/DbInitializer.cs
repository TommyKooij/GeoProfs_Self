...
namespace GeoProfs.Data
{
    public static class DbInitializer
    {
        public static void Initialize(GeoProfsContext context)
        {
            ...
            {
                new Worker{FirstMidName="Carson",LastName="Alexander",EnrollmentDate=DateTime.Parse("2019-09-01"),IsPresent=true},
                new Worker{FirstMidName="Meredith",LastName="Alonso",EnrollmentDate=DateTime.Parse("2017-09-01"),IsPresent=false},
                new Worker{FirstMidName="Arturo",LastName="Anand",EnrollmentDate=DateTime.Parse("2018-09-01"),IsPresent=true},
                new Worker{FirstMidName="Gytis",LastName="Barzdukas",EnrollmentDate=DateTime.Parse("2017-09-01"),IsPresent=true},
                new Worker{FirstMidName="Yan",LastName="Li",EnrollmentDate=DateTime.Parse("2017-09-01"),IsPresent=false},
                new Worker{FirstMidName="Peggy",LastName="Justice",EnrollmentDate=DateTime.Parse("2016-09-01"),IsPresent=true},
                new Worker{FirstMidName="Laura",LastName="Norman",EnrollmentDate=DateTime.Parse("2018-09-01"),IsPresent=true},
                new Worker{FirstMidName="Nino",LastName="Olivetto",EnrollmentDate=DateTime.Parse("2019-09-01"),IsPresent=true}
            };
            ...
            var roles = new Role[]
            {
                new Role{RoleID=0,RoleName="Employee"},
                new Role{RoleID=1,RoleName="Team Manager"}
            };
