        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reasoning = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    TeamManager = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Absence Proposal", x => x.AbsenceProposalID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(590)", maxLength: 590, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enrollment_Calendar_CalendarEventID",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Enrollment_Worker_WorkerID",
                        column: x => x.WorkerID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollment_CalendarEventID",
                table: "Enrollment",
